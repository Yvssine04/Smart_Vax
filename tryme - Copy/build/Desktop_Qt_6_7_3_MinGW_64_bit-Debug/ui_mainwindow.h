...
""));
        ...
        date_rdv->setDateTime(QDateTime(QDate(2024, 8, 19), QTime(0, 0, 0)));
        date_rdv->setMinimumDateTime(QDateTime(QDate(1970, 8, 19), QTime(0, 0, 0)));
...
""));
        ...
        date_rdv_2->setDateTime(QDateTime(QDate(2024, 8, 18), QTime(0, 0, 0)));
        date_rdv_2->setMinimumDateTime(QDateTime(QDate(1970, 8, 18), QTime(0, 0, 0)));
...
""));
        ...
        centralWidget->setObjectName("centralWidget");
        centralWidget->setGeometry(QRect(100, 0, 321, 351));
        QFont font17;
