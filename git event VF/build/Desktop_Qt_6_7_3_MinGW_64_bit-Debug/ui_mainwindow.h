...
""));
        ...
        date_rdv->setDateTime(QDateTime(QDate(2024, 8, 12), QTime(0, 0, 0)));
        date_rdv->setMinimumDateTime(QDateTime(QDate(1970, 8, 12), QTime(0, 0, 0)));
...
""));
        ...
        date_rdv_2->setDateTime(QDateTime(QDate(2024, 8, 11), QTime(0, 0, 0)));
        date_rdv_2->setMinimumDateTime(QDateTime(QDate(1970, 8, 11), QTime(0, 0, 0)));
