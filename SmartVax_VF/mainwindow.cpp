...
void MainWindow::on_cameraButton_clicked()
{
    if (!cap.isOpened()) {
        ...
        if (cap.isOpened()) {
            ...
            // Run the YOLOv5 detection in a separate Python process
            //QProcess::startDetached("C:/Users/marie/Documents/yolov5/yolov5env/Scripts/python.exe", QStringList() << "C:/Users/marie/Documents/yolov5/detect.py" << "--weights" << "yolov5s.pt" << "--source" << "0");
        ...
        ui->camerafeed->clear(); // Clear the feed
    }
}
