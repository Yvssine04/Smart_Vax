...
bool medecin::saveMedData(QString id_e, const QString &prenom_e, const QString &nom_e,
    ...
    QSqlQuery query;
    query.prepare("INSERT INTO EMPLOYEES (ID, PRENOM_E, NOM_E, ANNEE_EXP, SPECIALITE, NUM_TEL, MAIL_E, SEXE, ADRESSE_E, MDP_E) "
                  "VALUES (:id_e, :prenom_e, :nom_e, :annee_exp_e, :specialite_e, :num_tel_e, :mail_e, :sexe_e, :adresse_e, :mdp_e)");
