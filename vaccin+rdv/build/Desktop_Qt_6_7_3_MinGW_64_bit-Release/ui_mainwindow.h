...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(70, 10, 81, 31));
        ...
        alert->setGeometry(QRect(0, 0, 131, 61));
        QFont font2;
...
"background-color: rgb(31, 109, 119);"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/bell.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        alert->setIcon(icon3);
        centralWidget = new QWidget(widget_3);
        centralWidget->setObjectName("centralWidget");
        centralWidget->setGeometry(QRect(20, 50, 121, 241));
        addAlert = new QPushButton(widget_3);
        addAlert->setObjectName("addAlert");
        addAlert->setGeometry(QRect(50, 0, 83, 29));
...
"border-radius :25px\n"
""));
        supprimerevent_3->setIcon(icon5);
...
"color: rgb(0, 0, 0);\n"
""));
        QIcon icon8(QIcon::fromTheme(QIcon::ThemeIcon::DocumentPrintPreview));
        rdv_pdf->setIcon(icon8);
...
""));
        ...
        date_rdv->setDateTime(QDateTime(QDate(2024, 8, 25), QTime(0, 0, 0)));
        date_rdv->setMinimumDateTime(QDateTime(QDate(1970, 8, 25), QTime(0, 0, 0)));
...
""));
        ...
        date_rdv_2->setDateTime(QDateTime(QDate(2024, 8, 24), QTime(0, 0, 0)));
        date_rdv_2->setMinimumDateTime(QDateTime(QDate(1970, 8, 24), QTime(0, 0, 0)));
...
"border-radius: 15px;"));
...
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
        palette14.setBrush(QPalette::Disabled, QPalette::PlaceholderText, brush21);
#endif
        palette14.setBrush(QPalette::Disabled, QPalette::Accent, brush22);
        widget->setPalette(palette14);
        QFont font15;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        addAlert->setText(QCoreApplication::translate("MainWindow", "add alert", nullptr));
