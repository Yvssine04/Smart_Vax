...
""));
        ...
        date_rdv->setDateTime(QDateTime(QDate(2024, 8, 4), QTime(0, 0, 0)));
        date_rdv->setMinimumDateTime(QDateTime(QDate(1970, 8, 4), QTime(0, 0, 0)));
...
""));
        ...
        date_rdv_2->setDateTime(QDateTime(QDate(2024, 8, 3), QTime(0, 0, 0)));
        date_rdv_2->setMinimumDateTime(QDateTime(QDate(1970, 8, 3), QTime(0, 0, 0)));
