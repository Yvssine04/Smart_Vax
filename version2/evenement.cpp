...
void Evenement::exporterInvitationPDF(QTableWidget *tabevent) {
    ...
    QString html = "<!DOCTYPE html>"
                   ...
                   "background: white; text-align: center; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); border-radius: 10px; }"

                   "#header { display: flex; align-items: center; justify-content: flex-start; border-bottom: 3px solid #4CAF50; padding-bottom: 10px; }"
                   "#header img { height: 80px; margin-right: 15px; }"
                   "#header h1 { font-size: 22px; color: #4CAF50; margin: 0; text-align: left; }"

                   "#title { font-size: 20px; font-weight: bold; color: #4CAF50; margin: 15px 0; }"

                   "#info { text-align: left; font-size: 14px; margin-top: 15px; line-height: 1.6; }"
                   "#info p { margin: 5px 0; }"

                   "#signature-container { display: flex; justify-content: space-between; align-items: center; margin-top: 40px; }"
                   "#signature { text-align: right; font-style: italic; }"
                   "#signature img { height: 80px; margin-top: 10px; }"

                   "#footer { margin-top: 20px; font-size: 12px; text-align: center; color: black; padding: 10px; border-radius: 0 0 10px 10px; }"
                   "</style>"
                   "</head>"
                   "<body>"
                   "<div id=\"container\">"
