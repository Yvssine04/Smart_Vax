...
public:
    ...
    void fetchVaccinData(int reference, QLineEdit *referenceEdit, QComboBox *nomEdit, QComboBox *typeEdit, QLineEdit *ageEdit, QComboBox *modeEdit, QLineEdit *doseEdit, QDateEdit *dateEdit, QLineEdit *prixEdit, QLineEdit *quantiteEdit);
