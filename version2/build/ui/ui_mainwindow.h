...
""));
        ...
        chatbot_page->setGeometry(QRect(630, 50, 61, 51));
        QPalette palette6;
        ...
        chatbot_page->setStyleSheet(QString::fromUtf8("background-color:rgb(63, 123, 134);\n"
"font: 18pt \"Segoe UI\";\n"
"border: 2px solid #000000;\n"
"border-radius: 25px;\n"
""));
        chatbot_page->setIcon(icon5);
        chatbot_page->setIconSize(QSize(42, 36));
...
""));
        ...
        date_rdv->setDateTime(QDateTime(QDate(2024, 8, 13), QTime(0, 0, 0)));
        date_rdv->setMinimumDateTime(QDateTime(QDate(1970, 8, 13), QTime(0, 0, 0)));
...
""));
        ...
        date_rdv_2->setDateTime(QDateTime(QDate(2024, 8, 12), QTime(0, 0, 0)));
        date_rdv_2->setMinimumDateTime(QDateTime(QDate(1970, 8, 12), QTime(0, 0, 0)));
...
"border-radius: 15px;"));
        ...
        chatbot = new QTableView(tab_11);
        chatbot->setObjectName("chatbot");
        chatbot->setGeometry(QRect(370, 60, 531, 631));
        chatbot->setStyleSheet(QString::fromUtf8("background-color:rgb(63, 123, 134);\n"
"border: 2px solid #000000;\n"
"border-radius: 15px;"));
        chatbot_line = new QLineEdit(tab_11);
        chatbot_line->setObjectName("chatbot_line");
        chatbot_line->setGeometry(QRect(390, 620, 501, 51));
        chatbot_line->setStyleSheet(QString::fromUtf8("border: 2px solid #000000;\n"
"border-radius: 15px;\n"
"background-color: rgb(255, 255, 255);"));
